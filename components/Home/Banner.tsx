const Banner = () => {
    return (
        <section className="relative bg-banner h-screen bg-cover bg-center">
            <div className="container px-4 text-white pt-[450px] md:pt-96 lg:pl-[50px] pl-[50px] w-full lg:w-[900px]">
                <h2 className="text-[22px] md:text-[44px] lg:text-[54px] font-bold">
                    Lorem ipsum dolor sit amet
                </h2>
                <p className="mt-4 text-[10px] md:text-[16px] lg:text-[18px]">
